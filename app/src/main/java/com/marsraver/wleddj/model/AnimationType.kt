...
enum class AnimationType(val displayName: String, val isAudioReactive: Boolean = false) {
    ...
    @SerialName("Fireflies") FIREFLIES("Fireflies", true),
    ...
    @SerialName("Akemi") AKEMI("Akemi", true),
    ...
    @SerialName("Swirl") SWIRL("Swirl", true),
    ...
    @SerialName("Plasmoid") PLASMOID("Plasmoid", true),
    ...
    @SerialName("Puddles") PUDDLES("Puddles", true),
    @SerialName("Lissajous") LISSAJOUS("Lissajous"),
    @SerialName("Tartan") TARTAN("Tartan"),
    @SerialName("Waverly") WAVERLY("Waverly", true),
    ...
    @SerialName("FunkyPlank") FUNKY_PLANK("Funky Plank", true),
    @SerialName("DriftRose") DRIFT_ROSE("Drift Rose"),
    @SerialName("Matripix") MATRIPIX("Matripix", true), 
    @SerialName("WavingCell") WAVING_CELL("Waving Cell"),
    @SerialName("Frizzles") FRIZZLES("Frizzles"),
    @SerialName("PixelWave") PIXEL_WAVE("Pixel Wave", true),
    @SerialName("FreqMatrix") FREQ_MATRIX("Freq Matrix", true),
